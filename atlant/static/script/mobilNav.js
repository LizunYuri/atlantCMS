...
const toggleCenter = document.querySelector('.toggle-center')
const toggleTop = document.querySelector('.toggle-first')
const toggleBottom = document.querySelector('.toggle-last')
